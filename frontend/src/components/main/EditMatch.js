...
export default function EditMatch(props) {
    ...
    function editMatch() {
        ...
        let image = document
            ...
            UserService
            .editMatch(props.post._id, teamA, teamB, group, date, image)
        ...
        // let deleteList = props.featuredPosts.filter((item) => item._id !==
        // props.post._id); let newList = deleteList.concat({teamA, teamB, group, date,
        // image})
    ...
    function deleteMatch() {
        ...
        let newList = props
            .featuredPosts
            .filter((item) => item._id !== props.post._id);
        props.setFeaturedPosts(newList)
    }
    ...
    return (
        <React.Fragment>
            ...
            {
                AuthService.canWrite() && <Button color="secondary" onClick={deleteMatch}>
                        {t("delete_button")}
                    </Button>
            }
            <div>
