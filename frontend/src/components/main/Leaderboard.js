            ...
            <Container maxWidth="lg">
                ...
                <main>
                    ...
                    <Grid container="container">
                        <h3>{t("top_100")}</h3>
                        <Table/> {
                            AuthService.canEdit() && AuthService.canWrite() && <React.Fragment>
                                    <Grid item="item" xs={6}>
                                        <center>
                                            <h3>{t("player_scores")}</h3>
                                        </center>
